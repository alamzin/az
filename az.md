...
**Эмодзи-новояз** — замена негативных эмодзи в случаях, когда платформа (например, мессенджер MAX) не позволяет их ставить. Например: 🗿,🌚 и 👀. ([первоисточник](https://t.me/spb_danger/72904))
